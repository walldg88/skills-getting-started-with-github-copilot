...
activities = {
    ...
    "Basketball Club": {
        ...
        "max_participants": 20,
        "participants": ["josh@mergington.edu", "maria@mergington.edu"]
    },
    "Art Workshop": {
    ...
    "Drama Club": {
        "description": "Rehearse and perform plays, monologues, and skits",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["anya@mergington.edu", "mason@mergington.edu"]
    },
    "Science Club": {
